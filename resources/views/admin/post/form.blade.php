    ...
    <div class="tab-pane active" id="tab_id">
       <div class="box-body">
         ...
         <div class="form-group {{ $errors->has('description_id') ? ' has-error' : '' }}">
            ...
            {!! Form::textarea('description_id',null, ['class'=>'tinyeditor form-control']) !!}
    ...
    <div class="tab-pane" id="tab_en">
       <div class="box-body">
         ...
         <div class="form-group {{ $errors->has('description_en') ? ' has-error' : '' }}">
            ...
            {!! Form::textarea('description_en',null, ['class'=>'tinyeditor form-control']) !!}
                   ...
                   <div class="row" id="imageList">
                     ...
                     <div class="col-md-3">
                          <label class="cabinet center-block img-preview" id="crop-square">
                            ...
                            <input type="file" class="item-img file center-block" name="file_photo" data-width="500" data-height="500" data-size="square"/>
                          </label>
                     </div>
                   </div>
               </div><!-- /.form group -->
